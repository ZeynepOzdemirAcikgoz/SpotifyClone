...
final class AuthManager {
    ...
    struct Constants{
        ...
        static let scopes = "user-read-private%20playlist-read-private%20playlist-modify-public%20playlist-modify-private%20user-follow-read%20user-library-modify%20user-library-read%20user-read-email"
    }
    ...
    //yenilenme kontrol ediliyor eğer eklenmediyse ekleniyor
    private var onRefreshBlocks = [((String) -> Void)]()
    
    //Supplies valid token to be used with API Calls
    // geçerli belirteç sğalandığında API çağrıldığında kullanılır
